      ...
      <div className="flex justify-center items-center">
        <div className="flex w-[80%] justify-center gap-28 px-20 py-10 ">
          ...
          <div className="flex items-center justify-center gap-10">
            <a
              href="#"
              className="bg-red-600 p-3 hover:scale-110 hover:translate-y-[-15px] shadow-md hover:bg-red-700 transition-all rounded-full"
            >
          ...
          <div className="w-64 h-64 shadow-lg rounded-full flex items-center justify-center bg-red-600">
